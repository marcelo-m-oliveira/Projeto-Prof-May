...
<div class="container">
    ...
    <div class="card-deck">
        <div class="card">
            <img class="salgados card-img-top" src="imagens/100-salgados-fritos-para-festa.jpg" alt="">
            <div class="card-body">
        ...
        <div class="card">
            <img class="salgados card-img-top" src="imagens/esfirra-aberta-de-carne-para-diabeticos.jpg" alt="">
            <div class="card-body">
        ...
        <div class="card">
            <img class="salgados card-img-top" src="imagens/quibe-de-bacalhau.jpg" alt="">
            <div class="card-body">
        ...
        <div class="card">
            <img class="salgados card-img-top" src="imagens/pastelzinho.jpg " alt="Nature">
            <div class="card-body">
                <h5 class="card-title">Pastelzinho</h5>
                <p class="card-subtitle mb-2 text-muted my-3">Um delicioso pastelzinho de carne focado na crocância</p>
                <a class="btn btn-outline-success" href="#" data-toggle="modal" data-target="#Comprar">Comprar R$ 1,00</a>
            </div>
            <div class="card-footer">
                <small class="text-muted">Topissimo</small>
...
<div class="container my-5">
    <div class="card-deck">
        <div class="card">
            <img class="salgados card-img-top" src="imagens/queijo.jpg" alt="">
            <div class="card-body">
                <h5 class="card-title">Bolinho de Queijo</h5>
                <p class="card-subtitle mb-2 text-muted my-3">Feito pra vegetarianos (e não vegetarianos tbm hahaha)</p>
                <a class="btn btn-outline-success" href="#" data-toggle="modal" data-target="#Comprar">Comprar R$ 1,00</a>
            </div>
            <div class="card-footer">
                <small class="text-muted">A melhor</small>
        ...
        <div class="card">
            <img class="salgados card-img-top" src="imagens/carne-seca.jpg" alt="">
            <div class="card-body">
        ...
        <div class="card">
            <img class="salgados card-img-top" src="imagens/calabresa.jpg" alt="">
            <div class="card-body">
        ...
        <div class="card">
            <img class="salgados card-img-top" src="imagens/churros.jpg" alt="">
            <div class="card-body">
